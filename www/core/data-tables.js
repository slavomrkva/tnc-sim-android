...
var LESSONS = [
{
  ...
  slides:[
    ...
    { html:function(){ return ''
      ...
      + '</div>'; } },
    { html:function(){ return ''
      + '<p>Practice uses the real editor. The goals show what will be checked. Press the green <b>Check</b> button when ready; each goal then turns green or red.'
  ...
  tasks:[
    {
      ...
      checks:[
        ...
        {t:'cycle_param', num:209, after:/TOOL\s+CALL\s+7\b/, q:'Q256', value:0.5, label:'Chip-break retract factor Q256 = +0.5 × pitch',
         hint:'Q256=+0.5 retracts by 0.5 × Q239, the thread pitch.'},
