# Graph Report - tnc-sim-android-c15  (2026-07-16)

## Corpus Check
- 69 files · ~213,423 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2335 nodes · 4248 edges · 153 communities (86 shown, 67 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 61 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6bddc4eb`
...
- `environment()` --indirect_call--> `advance()`  [INFERRED]
  tests/android-webgl-compat.test.js → www/core/voxel-cutting.js
...
## Communities (153 total, 67 thin omitted)

### Community 0 - "Three.js Core Engine"
Cohesion: 0.03
Nodes (37): Ba, bo, $c(), ci, cn, compileCubemapShader(), compileEquirectangularShader(), _compileMaterial() (+29 more)

### Community 1 - "WebGL Texture Binding"
Cohesion: 0.03
Nodes (25): ar(), br(), cr(), dr(), fr(), gr(), hr(), ir() (+17 more)
...
Cohesion: 0.13
Nodes (9): bs, dispose(), ft(), ni, pi(), ws(), Xn(), yi() (+1 more)
...
Cohesion: 0.20
Nodes (9): isAndroidApp(), readSafeMode(), readStorage(), rememberSafeMode(), removeStorage(), safeRequestedByUrl(), userAgent(), watchRenderer() (+1 more)

### Community 57 - "3D Scene Rendering"
Cohesion: 0.04
Nodes (50): app, assert, background, backgroundCanvas, backgroundRace, backgroundRaceCanvas, bridgeRace, fs (+42 more)
...
Cohesion: 0.19
Nodes (7): bindSkeletons(), parse(), parseAnimations(), parseGeometries(), parseObject(), parseShapes(), parseSkeletons()
...
### Community 75 - "Xn"
Cohesion: 0.12
Nodes (8): constructor(), ei, fi(), i(), rt, setDirection(), update(), wi()
...
Cohesion: 0.14
Nodes (5): fa, Ga, hh, setFromCamera(), wh()
...
### Community 113 - "Ll"
Cohesion: 0.13
Nodes (8): cl, ds(), Jr(), qr(), setValue(), ti, Wn, Yh()
...
Cohesion: 0.09
Nodes (22): 1.0.1 (versionCode 2), 1.0.2 (versionCode 3), 1.0.3 (versionCode 4), 1.0 (versionCode 1), Diagnostic test build (APP_VERSION 1.0.49), Diagnostic test build (APP_VERSION 1.0.50), Diagnostic test build (APP_VERSION 1.0.51), Diagnostic test build (APP_VERSION 1.0.52) (+14 more)

### Community 122 - "Clone Constructor Pair"
Cohesion: 0.67
Nodes (3): canvas(), environment(), eventTarget()

### Community 123 - "ol"
Cohesion: 0.15
Nodes (6): load(), oc, ol, parseImages(), setTexturePath(), ul

### Community 124 - ".getCamera"
Cohesion: 0.17
...
Cohesion: 0.08
Nodes (22): APP_VERSION 1.0.37 — documentation damage control, APP_VERSION 1.0.38 — machining demos and accepted web ports, APP_VERSION 1.0.41 — adaptive Android WebGL compatibility, APP_VERSION 1.0.42 — accepted Learn audit port, APP_VERSION 1.0.43 — accepted shorter tutorial port, APP_VERSION 1.0.44 — Tool Table workflow hardening, APP_VERSION 1.0.45 — HEIDENHAIN cycle, cutting and validator corrections, APP_VERSION 1.0.46 — first tutorial orientation lesson (+14 more)

## Knowledge Gaps
- **309 isolated node(s):** `name`, `version`, `description`, `main`, `test` (+304 more)
...
- **Why does `Lt` connect `Vector3 Operations` to `Three.js Core Engine`, `Android Unit Test`, `Bounding Box Math`, `Ray and Sphere Math`, `Buffer Attribute Transforms`, `Object Serialization`, `2D Path Drawing`, `Spherical Harmonics Math`, `Line3 Geometry Math`, `Render Target Setup`, `Camera Ray Utilities`, `Scene Object Traversal`, `Geometry Transform Helpers`, `Quadratic Bezier Curve`, `Frustum and Plane Math`, `Geometry Normal Computation`, `Matrix3 Math`, `Render Object Lifecycle`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `Ce` connect `Scene Object Traversal` to `Three.js Core Engine`, `Quaternion Math Operations`, `zo`, `Raycaster Intersection`, `Matrix Column Parsing`, `Object Serialization`, `Clone Constructor Update Pattern`, `Bone Transform Updates`, `Property Binding Values`, `Web App Manifest`, `Render Object Lifecycle`, `Scene Graph Management`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `pt()` connect `Spherical Harmonics Math` to `Three.js Core Engine`, `Buffer Attribute Transforms`, `Bounding Box Math`, `Ray and Sphere Math`, `Geometry Transform Helpers`, `Render Object Lifecycle`, `Euler Rotation Clone`?**
...
- **Should `Three.js Core Engine` be split into smaller, more focused modules?**
  _Cohesion score 0.02836637047163363 - nodes in this community are weakly interconnected._
