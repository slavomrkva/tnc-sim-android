# TNC Sim Android — project notes through 1.0.36 (historical snapshot)

> Historical reference only. Current instructions live in root `CLAUDE.md` and
> `NOTES.md`; continuing technical entries live in `docs/history/changelog.md`.
> Do not treat rules in this snapshot as newer than the current contract.
