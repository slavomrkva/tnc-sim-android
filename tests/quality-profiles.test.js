...
assert.match(parser, /var LIVE_VOXEL_BUDGET = 12000000;/);
assert.match(parser, /var REFINE_VOXEL_BUDGET = 32000000;/);
assert.match(parser, /var resolutions=compat\?\[50,75,100\]:\[100,150,200\]/);
assert.match(parser, /var caps=compat\?\[2\.0,1\.5,1\.0\]:\[1\.0,0\.7,0\.5\]/);
