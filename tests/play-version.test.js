...
assert.strictEqual(appVersion, '1.0.107', 'the already-merged internal build marker must stay unchanged');

console.log('play-version.test.js: next Play release is 1.0.6/code 7; APP_VERSION remains 1.0.107');
